            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="text-center">
                        ...
                        <div class="p-5">
                            <iframe loading="lazy" width="400" height="240" src="https://www.givey.com/embeds/fundraisers/northwirralsantasleigh2022/widget?layout=vertical" style="border: none; max-width: 100%;"></iframe>
                        </div>
                    </div>
                </div>
            </div>
